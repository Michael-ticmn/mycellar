...
- [ ] [owner] Apply the three guest-share migrations in order in the Supabase SQL Editor: [`0008_share_links.sql`](supabase/migrations/0008_share_links.sql) (table + resolve + sanitized bottle list), [`0009_share_links_ai.sql`](supabase/migrations/0009_share_links_ai.sql) (per-link AI request RPCs + `share_link_id` column on `pairing_requests`), [`0010_share_create.sql`](supabase/migrations/0010_share_create.sql) (owner-side create-link RPC; revokes prior active link).
